...
name: documentation
description: |
  Creates and maintains documentation files (README, CHANGELOG, AGENTS.md, API docs, etc.).
...
- **AGENTS.md / CLAUDE.md** — codebase instructions for AI coding agents (architecture, key files, dev patterns)
...
- **AGENTS.md / CLAUDE.md specifics**: Focus on what an AI coding agent needs to know — architecture decisions, key files, build commands, development patterns, gotchas.
