...
Agent files use YAML frontmatter (name, description, tools, model, color) followed by markdown sections: Role, Tool Names, Process, File Ownership, Verification, On Revision, Self-Review Checklist, Reflection, Submitting Results, Debug Logging, Writing to Memory. New agents should follow this structure.
