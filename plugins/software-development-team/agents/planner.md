...
Every step MUST include at least one **executable verification command** in its acceptance criteria. The reviewer will run these commands to verify the step is complete.
...
- Decomposition patterns that work well for this project (step sizing, dependency structures)
- Architectural decisions and their rationale
- Codebase conventions and patterns the coder should follow
- What plan structures led to smooth execution vs. revision cycles

Consult your memory at the start of every planning session to leverage past learnings.
