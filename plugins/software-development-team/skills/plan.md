...
Use the **Agent tool** (the built-in Claude Code tool) to dispatch the planner:

```
Agent(
  description: "Plan the task: <task description>",
...
Use the **Agent tool** to dispatch the plan-critic for an adversarial review of the draft:

```
Agent(
  description: "Adversarial review of draft plan for: <task description>",
...
Use the **Agent tool** to dispatch the planner again, passing the original task, the draft plan, and the full critique:

```
Agent(
  description: "Revise plan based on critic feedback: <task description>",
  subagent_type: "software-development-team:planner",
  prompt: "<see dispatch prompt below>"
)
```
...
>
> To execute this plan, run: `/software-development-team:begin <task description>`
>
